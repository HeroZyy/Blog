...
public class HcodeAutoCode {
    ...
    public static void main(String[] args) {
        ...
        projectPath += "/vueblog-master/blog-springboot";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3500/ry-vue?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2b8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("Ft05ab");
