<template>
  <div>
    ...
    <div class="content">
      ...
      <div class="markdown-body" v-html="blog.column1"></div>
    </div>
    <Footer></Footer>
  </div>
</template>
  ...
  created() {
    ...
    if (blogId) {
      this.$axios.get("/blog/" + blogId).then(res => {
        ...
        let result = md.render(blog.column1);

        this.blog.column1 = result;
        // 判断是否为该作者，是才能编辑
