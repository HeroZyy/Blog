    ...
    <div class="edit-content">
      ...
      >
        ...
        <el-form-item label="内容" prop="column1">
          <mavon-editor v-model="ruleForm.column1"></mavon-editor>
        </el-form-item>
  ...
  data() {
    return {
      ruleForm: {
        ...
        description: "",
        column1: "",
        author: this.$store.getters.getUserInfo.user_name
      },
      rules: {
        title: [
        ...
        column1: [{ required: true, trigger: "blur" }]
      }
    };
  },
  methods: {
  ...
  created() {
    ...
    if(blogId){
      this.$axios.get("/blog/"+blogId).then(res=>{
        ...
        this.ruleForm.column1 = blog.column1
      })
    }
  }
};
